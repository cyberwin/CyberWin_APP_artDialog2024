...
#alert-layer{
	...
	f.layer = function(content,cyberwin_obj){
		...
		var wlzc_tool_bar_close_html = "<div class=\"return\" onClick=\"cyberwin_closedlg('"+未来之窗_layer_id + "');\" style=\"width:" + 未来之窗_layer_titlebar_closewidth + ";\">"+未来之窗_layer_btncancel+"</div>";
		...
		var 未来之窗元素_标题 = `<div class="set_top"><div class="set" style="cursor:move;`+未来之窗_layer_titlebar_captionstyle+`">`+未来之窗_layer_title+"</div>"
		    +wlzc_tool_bar_close_html
				+"</div>";
	   ...
	   if(未来之窗_layer_hidetitle==true){
		...
		var content_html_mask = '<cyberdiv class="cyberwin_dialog_mask" id="'+未来之窗_layer_id+`" style="`+未来之窗_layer_mask_style+`"><div class="cyberwin_dialog_localapp_fix " style="dispaly:none1;width:`+未来之窗_layer_width+`;height:`+未来之窗_layer_height+`;min-height:`+未来之窗_layer_height+`;`+未来之窗_layer_alignmentstyle+未来之窗_div_透明+`">
		`+未来之窗元素_标题+`
		<div class="set_end clr" style="height:`+未来之窗_layer_body_height+`;overflow-y:auto;">`+content+
			"</div>"+
		"</div></cyberdiv>";
